		...
		switch(A_u8_PortNum)
		{
			case PORTA:
				...
				switch (A_u8_PinValue)
					{
						case LOW  : CLR_BIT(DIO_PINA_REG,A_u8_PinNum);break;
						case HIGH : SET_BIT(DIO_PINA_REG,A_u8_PinNum);break;
					}
			break;
			...
			case PORTB:
				...
				switch (A_u8_PinValue)
					{
						case LOW  : CLR_BIT(DIO_PINB_REG,A_u8_PinNum);break;
						case HIGH : SET_BIT(DIO_PINB_REG,A_u8_PinNum);break;
					}
			break;
			...
			case PORTC:
				...
				switch (A_u8_PinValue)
					{
						case LOW  : CLR_BIT(DIO_PINC_REG,A_u8_PinNum);break;
						case HIGH : SET_BIT(DIO_PINC_REG,A_u8_PinNum);break;
					}
			break;
			...
			case PORTD:
				...
				switch (A_u8_PinValue)
					{
						case LOW  : CLR_BIT(DIO_PIND_REG,A_u8_PinNum);break;
						case HIGH : SET_BIT(DIO_PIND_REG,A_u8_PinNum);break;
					}
			break;
		}
	}
